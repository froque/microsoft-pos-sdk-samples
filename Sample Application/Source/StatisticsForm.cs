			...
			try
			{
				...
				else if (radioButton3.Checked)
				{
					...
					if (vals.Length != stats.Length)
					{
                        ...
                        MessageBox.Show("The number of statistics does not match the number of values.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, options);
						return;
					}
