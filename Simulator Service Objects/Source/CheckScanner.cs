...
namespace Microsoft.PointOfService.DeviceSimulators
{
        ...
        private void button3_Click(object sender, System.EventArgs e)
        {
            ...
            if (s != null)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show(this, string.Format(CultureInfo.CurrentCulture, "Unable to load image file: {0}", textBox1.Text), this.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
                    else
                    {
	...
	[ServiceObjectAttribute(DeviceType.CheckScanner, 
        ...
        "Microsoft Check Scanner Simulator", 1, 14)]
